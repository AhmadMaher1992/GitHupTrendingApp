...
@IBDesignable public class CustomSegment: UIControl {
    
    fileprivate var labels = [UILabel]()
    private var thumbView = UIView()
    
    public var items: [String] = ["Last Day", "Last Week" , "Last Month"] {
        didSet {
    ...
    @IBInspectable public var border_Color: UIColor = #colorLiteral(red: 0.9254901961, green: 0.8705882353, blue: 0.831372549, alpha: 1) {
        didSet { layer.borderColor = border_Color.cgColor }
    }
